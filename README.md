...
./CarSimulator
```
Authors: Erik Babonis and Rylee Hopper
...
| `Camera.h` | Driver | Defines the Camera class, simulating basic camera functionality like capturing a frame or starting/stopping streaming. |
